  ...
  <body>
    ...
    <main>
      <section class="card" id="html section">
        <h2>HTML</h2>
        <ul>
          <li>The elemnt head contains information about the webpage </li>
          <li>The Body element represents the visible content shown to the user</li>
          <li>Metadata is data about our webpage that the browser uses to effectively serve our webpage to users</li>
          <li> Better SEO results in your website more frequently showing up in searches.</li>
      ...
      <section class="card" id="CSS-section">
        ...
        <ul>
          ...
          <li>Declarations contain two important components= Property(color),Value(blue)</li>
        </ul>
      </section> 
